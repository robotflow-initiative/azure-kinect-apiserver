...
class RecordConfiguration:
    ...
    def to_dict(self):
        return {
            'color_format': self._handle.color_format,
            'color_resolution': self._handle.color_resolution,
            'depth_mode': self._handle.depth_mode,
            'depth_delay_usec': self._handle.depth_delay_off_color_usec,
            'camera_fps': [5, 15, 30][self._handle.camera_fps],
            'imu': self._handle.imu_track_enabled,
            'sync_mode': self._handle.wired_sync_mode,
            'sync_delay_usec': self._handle.subordinate_delay_off_master_usec,
            "color_track_enabled": self._handle.color_track_enabled,
            "depth_track_enabled": self._handle.depth_track_enabled,
            "ir_track_enabled": self._handle.ir_track_enabled,
            "start_timestamp_offset_usec": self._handle.start_timestamp_offset_usec,
        }
